    ...
    <article className={s.aboutPetSitter}>
      <div className={s.overexposure}>
        <div className={s.overexposureDog}>
          <img src='/assets/images/Home/expDog.png' alt='dog' className={s.imageDog} />
        ...
        <div className={s.overexposureCat}>
          <img src='/assets/images/Home/expCat.png' alt='dog' className={s.imageCat} />
      ...
      <div className={s.wrapperFrame}>
        <img src='/assets/icons/Home/Frame.png' alt='frame' className={s.frame} />
      </div>
    </article>
  );
}
