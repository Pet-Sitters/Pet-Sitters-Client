				...
				<div className={s.skillsDog}>
					...
					<div className={s.wrapDog}>
						...
						<p className={s.itemText}>
							{' '}
							<span className={s.accentSkill}>Умеют вытаскивать</span>{' '}
							подобранный кусок из пасти собаки
						</p>
						<p className={s.itemText}>
							{' '}
							<span className={s.accentSkill}>Поладят с собакой</span> , даже
							если у нее непростой характер
						</p>
						<p className={s.itemText}>
							{' '}
						...
						<p className={s.itemText}>
							<span className={s.accentSkill}>Знают что делать</span>, если
							собаке стало плохо
						</p>
					</div>
				</div>
